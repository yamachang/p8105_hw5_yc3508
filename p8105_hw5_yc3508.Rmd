...
__Plot A: A spaghetti plot showing observations on each subject over time__
...
Plot C: Show the proportion of times the null was rejected (the power of the test) on the y axis and the true value of β1 on the x axis
